...
<h1 class="h3 mb-4 text-gray-800">Edit Jadwal Pelajaran</h1>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.jadwal.update', $jadwal->id) }}">
            ...
            {{-- 2. Mata Pelajaran (mapel_id) --}}
            <div class="form-group mt-3">
                <label for="mapel_id">Mata Pelajaran</label>
                {{-- Mengubah input teks menjadi select agar konsisten dengan create dan relasi --}}
